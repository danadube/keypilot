...
CREATE TABLE "supra_queue_items" (
  "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "supra_queue_items_hostUserId_externalMessageId_key"
  ON "supra_queue_items"("hostUserId", "externalMessageId");

CREATE INDEX "supra_queue_items_hostUserId_queueState_idx"
  ON "supra_queue_items"("hostUserId", "queueState");

CREATE INDEX "supra_queue_items_hostUserId_receivedAt_idx"
