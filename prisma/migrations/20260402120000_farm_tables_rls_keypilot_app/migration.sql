-- FarmTrackr tables — keypilot_app RLS + grants (required for withRLSContext API routes).
-- Mirrors pattern in 20260331130100_follow_ups_rls_keypilot_app.
