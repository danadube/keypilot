  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6">
        <div>
          <h1 className="text-xl font-bold text-kp-on-surface">MarketPilot</h1>
          <p className="mt-1 text-sm text-kp-on-surface-variant">
            Market outreach and campaign planning.
          </p>
        </div>
        <div className="rounded-xl border border-kp-outline bg-kp-surface p-5">
          <p className="text-sm text-kp-on-surface-variant">
            Coming soon: campaigns and market visibility workflows.
          </p>
        </div>
      </div>
    </ModuleGate>
