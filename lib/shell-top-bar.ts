 ...
 *
 * Workspace modules (`/showing-hq/*`, `/open-houses/*`, `/property-vault/*`, `/properties/*`,
 * `/client-keep/*`, `/contacts/*`) use a taller band so the title + client date/time line fit;
 * other routes keep the compact rail.
 */
