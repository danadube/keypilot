...
// Bar color per interest level — highest-positive gets teal, lowest gets red
  ...
  if (state.status === "empty") {
    return (
      <div className="rounded-xl border border-kp-outline bg-kp-surface p-5">
        ...
        <p className="mt-3 text-sm text-kp-on-surface-variant">No feedback requests for this property yet.</p>
      </div>
    );
  }
