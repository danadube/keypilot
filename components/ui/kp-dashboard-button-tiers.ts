/**
 * Dark dashboard (kp-*) button tiers — use anywhere inside `kp-dashboard-app`.
 * Supra Inbox re-exports these as `supraBtn*` from `supra-inbox-button-tiers.ts`.
 * See docs/ui/supra-ui-rules.md.
 */
...
export const kpBtnDangerSecondary =
