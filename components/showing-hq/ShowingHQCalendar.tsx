...
export function ShowingHQCalendar({
  ...
  return (
    <div
      className={cn(
        "showing-hq-calendar rounded-lg border border-kp-outline bg-kp-surface-high",
        workbenchToolbar ? "overflow-hidden p-0" : "p-4"
      )}
    >
      {workbenchToolbar ? (
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-kp-outline bg-kp-surface-higher px-2 py-1.5">
          <div className="flex items-center gap-1 rounded-md border border-kp-outline/60 bg-kp-surface-high/90 p-0.5">
            <button
              type="button"
              ...
              className={cn(
                ...
                calView === "week"
                  ? "bg-kp-teal/20 text-kp-on-surface shadow-sm ring-1 ring-kp-teal/35"
                  : "text-kp-on-surface/85 hover:bg-kp-surface-higher hover:text-kp-on-surface"
              )}
            >
              Week
            </button>
          ...
          <div className="flex min-w-0 flex-1 items-center justify-center gap-0.5">
            <button
              type="button"
              onClick={() => nav("prev")}
              className="flex h-7 w-7 shrink-0 items-center justify-center rounded border border-kp-outline bg-kp-surface-high text-kp-on-surface hover:bg-kp-surface-higher"
              aria-label="Previous"
            >
              <ChevronLeft className="h-4 w-4" />
            </button>
            <span className="min-w-0 truncate px-1 text-center text-[12px] font-semibold tracking-tight text-kp-on-surface">
              {rangeTitle || "—"}
            </span>
            <button
              type="button"
